          ...
          <div className={styles.aboutbox}>
            <div className={styles.aboutme}>
              ...
              <h2>2. Technical Skills</h2>
                ...
                <p>I can code in BDScript very good and make pretty good JSONs. I can't create very good HTML & CSS. And I am a beginner at JavaScript, Python, Automate Flows, Windows CMD and PowerShell.</p>
                <p>I have contributed in a few wikipedia pages. Not as this user tho, I am staying anomylous as what user I had contributed with.</p>
